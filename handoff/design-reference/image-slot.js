...
(() => {
    ...
    class ImageSlot extends HTMLElement {
        ...
        constructor() {
            ...
            this._credit.addEventListener('dblclick', (e) =>
                e.stopPropagation(),
            );
            ...
            this._spill.addEventListener('pointerdown', (e) => {
                ...
                if (corner) {
                    ...
                    const contain =
                        (this.getAttribute('fit') || 'cover').toLowerCase() ===
                        'contain';
                    const base = contain
                    ...
                    move = (ev) => {
                        this._view.x =
                            start.x + ((ev.clientX - start.px) / fw) * 100;
                        this._view.y =
                            start.y + ((ev.clientY - start.py) / fh) * 100;
                        this._clampView();
                        this._applyView();
                    };
                }
        ...
        _render() {
            ...
            if (!this.hasAttribute('data-reframe')) {
                this._view = {
                    s:
                        stored && Number.isFinite(stored.s)
                            ? clampS(stored.s)
                            : 1,
            ...
            if (showCredit) {
                ...
                if (m) {
                    ...
                    this._credit.appendChild(
                        mkLink('Unsplash', UNSPLASH_HOMEPAGE_HREF),
                    );
                } else if (href) {
